...
namespace Game_Tetris.GameLogic
{
    ...
    class 土型:下落图形基类
    {
          public 土型(int x,int y):base(x,y) 
        {
            Blocks[0] = new 小方块(x,y+1);
